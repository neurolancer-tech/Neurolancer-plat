    ...
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <>
          ...
          {/* Notification panel */}
          <div className="absolute top-full mt-2 w-80 sm:w-96 md:w-80 max-w-[calc(100vw-1rem)] card rounded-lg shadow-lg border border-gray-200 dark:border-gray-600 z-[70] left-1/2 transform -translate-x-1/2 md:left-auto md:right-0 md:transform-none md:translate-x-0">
            {/* Header */}
