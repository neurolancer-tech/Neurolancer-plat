        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="flex space-x-4">
              <a href="https://www.instagram.com/neurolancerplatform/" target="_blank" rel="noopener noreferrer" className="group p-3 bg-gray-800 rounded-full hover:bg-teal-600 transition-all duration-300 transform hover:scale-110">
