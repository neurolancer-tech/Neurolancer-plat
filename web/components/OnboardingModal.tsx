...
export default function OnboardingModal({ isOpen, userType, onComplete }: OnboardingModalProps) {
  ...
  const renderClientStep2 = () => (
    <div className="space-y-4">
      <h2 className="text-xl font-semibold text-gray-900">What type of AI projects do you need help with?</h2>
      
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-3">Project Types (Select all that apply)</label>
        <div className="grid grid-cols-2 gap-2">
          {[
            ...
            <label key={type.value} className="flex items-center p-2 border rounded cursor-pointer hover:bg-gray-50">
              <input
                type="checkbox"
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-2">Typical Project Budget Range</label>
        <select
          name="budget_range"
  ...
  const renderClientStep3 = () => (
    <div className="space-y-4">
      <h2 className="text-xl font-semibold text-gray-900">Help us personalize your experience</h2>
      
      <div className="grid grid-cols-2 gap-4">
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">Main AI Goals (Optional)</label>
          <textarea
            name="goals"
      ...
      <div className="bg-blue-50 p-3 rounded-lg">
        ...
        <p className="text-sm text-blue-800">Browse AI experts, post projects, and get matched with specialists.</p>
      </div>
    </div>
  );
  ...
  const renderFreelancerStep1 = () => (
    <div className="space-y-4">
      <h2 className="text-xl font-semibold text-gray-900">What&apos;s your AI specialization?</h2>
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-2">Years of AI/ML Experience</label>
        <select
  ...
  const renderFreelancerStep2 = () => (
    <div className="space-y-4">
      <h2 className="text-xl font-semibold text-gray-900">Tell us about your work preferences</h2>
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-2">Expected Hourly Rate (USD)</label>
        <select
  ...
  const renderFreelancerStep3 = () => (
    <div className="space-y-4">
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-2">What are your career goals? (Optional)</label>
        <textarea
          name="goals"
          value={formData.goals}
          onChange={handleInputChange}
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="card rounded-xl shadow-2xl w-full max-w-4xl h-[70vh] flex flex-col">
            ...
            <div className="flex items-center space-x-4">
              {[1, 2, 3].map((step) => (
                <div key={step} className="flex items-center">
                  ...
                  {step < 3 && <div className="w-12 h-px bg-gray-300 mx-2"></div>}
                </div>
              ))}
            </div>
          </div>
            ...
            <div className="flex space-x-3">
              ...
              {currentStep < totalSteps ? (
                ...
                <button
                  ...
                  disabled={loading}
                  className="px-6 py-2 bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-lg hover:from-green-600 hover:to-emerald-700 transition-all shadow-md disabled:opacity-50"
                >
